...
if (! class_exists ( 'QuayRiskManager' )) :
	final class QuayRiskManager {
		...
		private function includes() {
			...
			require_once plugin_dir_path ( __FILE__ ) . 'includes/class-risk-post-type-registration.php';
			require_once plugin_dir_path ( __FILE__ ) . 'includes/qrm-class-definitions.php';
			require_once plugin_dir_path ( __FILE__ ) . 'includes/qrm-data-functions.php';
		...
		private function defineAJAXFunctions() {
			add_action ( "wp_ajax_getProject", array ($this,"getProject" ) );
			add_action ( "wp_ajax_getAllRisks", array ($this,"getAllRisks") );
			add_action ( "wp_ajax_getProjects", array ($this,"getProjects") );
			add_action ( "wp_ajax_getSiteUsersCap", array ($this,"getSiteUsersCap") );
			add_action ( "wp_ajax_getSiteUsers", array ($this,"getSiteUsers" ) );
			add_action ( "wp_ajax_saveSiteUsers", array ($this,"saveSiteUsers") );
			add_action ( "wp_ajax_saveProject", array ($this,"saveProject" ) );
			add_action ( "wp_ajax_getAllProjectRisks", array ($this,"getAllProjectRisks") );
			add_action ( "wp_ajax_getRisk", array ($this,"getRisk" ) );
			add_action ( "wp_ajax_saveRisk", array ($this,"saveRisk") );
			add_action ( "wp_ajax_updateRisksRelMatrix", array ($this,"updateRisksRelMatrix") );
			add_action ( "wp_ajax_getAttachments", array ($this,"getAttachments" ) );
			add_action ( "wp_ajax_uploadFile", array ($this,"uploadFile" ) );
			add_action ( "wp_ajax_uploadImport", array ($this,"uploadImport") );
			add_action ( "wp_ajax_getCurrentUser", array ($this,"getCurrentUser") );
			add_action ( "wp_ajax_saveRankOrder", array ($this,"saveRankOrder" ) );
			add_action ( "wp_ajax_registerAudit", array ($this,"registerAudit" ) );
			add_action ( "wp_ajax_getAllIncidents", array ($this,"getAllIncidents") );
			add_action ( "wp_ajax_getIncident", array ($this,"getIncident" ) );
			add_action ( "wp_ajax_saveIncident", array ($this,"saveIncident") );
			add_action ( "wp_ajax_addGeneralComment", array ($this,"addGeneralComment") );
			add_action ( "wp_ajax_getAllReviews", array ($this,"getAllReviews" ) );
			add_action ( "wp_ajax_getReview", array ($this,"getReview" ) );
			add_action ( "wp_ajax_saveReview", array ($this,"saveReview") );
			...
			add_action ( "wp_ajax_checkSession", array ($this,"checkSession") );
			add_action ( "wp_ajax_newPushDown", array ($this,"newPushDown" ) );
			add_action ( "wp_ajax_installSample", array ($this,"installSample") );
			add_action ( "wp_ajax_removeSample", array ($this,"removeSample" ) );
			add_action ( "wp_ajax_downloadJSON", array ($this,"downloadJSON" ) );
			add_action ( "wp_ajax_getJSON", array ($this,"downloadJSON" ) );
		}
