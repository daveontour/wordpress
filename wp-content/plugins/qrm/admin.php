		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					...
					<p>Users access to the QRM is limited to the users configured in the user access table. Select the user who will have access to the Quay Risk Manager</p>
					<p>Risks are arranged into "Risk Projects" which can be arranged into a heirarcical order. Use the "Risk Project" item in the Dashboard menu to add a new risk project</p>
					<p>Quay Risk Manager is accessed by either:
						<ol style="margin-top: 10px;padding-left:15px">
							<li>Selecting "View" from the list of Projects, Risks, Incident or Reviews</li>
							<li>Via the "Quay Risk Manager" page
						</ol>
					</p>
					
					<p>Once users have been enabled to use the system, sample data can be installed or removed 
					<div style="float: right; margin-top: 15px" ng-controller="sampleCtrl">
						<button type="button" class="btn btn-w-m btn-sm btn-primary"
							ng-click="installSample()">Install Sample Data</button>
						<button type="button" style="margin-left: 10px"
							class="btn btn-w-m btn-sm btn-warning" ng-click="removeSample()">Remove Sample Data</button>
					</div>
					</p>
			...
			<div class="row>
				<div class="col-sm-12 col-md-6 col-lg-6" >
					...
					<p>Projects can only be deleted if they have no child projects and no risks assigned to them</p>
					</div>
				</div>
			</div>
		</div>
